...
I've modified this a bit to reduce code and leverage other libraries
*/
...
const names = [
  ...
  const { r, g, b, h, s, l } = color(`#${hex}`);
  return [hex, colorName, r, g, b, h, s, l];
})

export default function getColorName(hexColor) {
  try {
    const { r, g, b, h, s, l } = color(hexColor);
    ...
    return (cl < 0 ? `Invalid Color: ${hexColor}` : names[cl][1]);
  } catch (err) {
